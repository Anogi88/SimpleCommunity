...
public class PublishActivity extends AppCompatActivity {
    ...
    private EditText content,articletitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        content=findViewById(R.id.pub_content);
        publish=findViewById(R.id.activity_selectimg_send);
        ...
        publish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //获取代码；开启线程；
                if (articletitle.getText().toString()==null){
                ...
                }else if(content.getText().toString()==null){
        ...
        back = findViewById(R.id.pub_back);//返回按钮
    ...
    private class RequestThread implements Runnable {
        ...
        public void run() {
            ...
            HttpPost httpRequest = new HttpPost("http://192.168.43.187/ceshi/community.php");
            //POST方法的参数列表
            ArrayList<BasicNameValuePair> params = new ArrayList<BasicNameValuePair>();
            //添加名为codeMsg的参数，值为代码输入框的内容。

            String article=content.getText().toString();
            String article_title=articletitle.getText().toString();

            params.add(new BasicNameValuePair("user_phone",phone));
            params.add(new BasicNameValuePair("content", article));
            params.add(new BasicNameValuePair("title", article_title));
