...
public class RepairMain extends AppCompatActivity {
    ...
    public RepairAdapter recordAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManager=new LinearLayoutManager(RepairMain.this,LinearLayoutManager.VERTICAL,false);
        ...
        public void handleMessage(Message msg){
            switch(msg.what){
                case 1://获取到what为1的消息，更新界面显示，不但包括提示信息，还要取消loading状态。
                    // RecyclerView适配器
                    recordAdapter = new RepairAdapter(RepairMain.this, repairList);
                    recyclerView.setAdapter(recordAdapter);
                    break;
                case  0:
                    Toast.makeText(RepairMain.this,(String)msg.obj, Toast.LENGTH_SHORT).show();
