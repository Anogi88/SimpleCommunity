...
public class GasDetail extends AppCompatActivity {
    private TextView gas_bill;//余额
    private TextView gas_above;//总费用
    private TextView gas_price;//水的单价
    private TextView gas_count;//用水吨数
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gas_above=findViewById(R.id.gas_above);
        gas_bill=findViewById(R.id.gas_bill);
        gas_count=findViewById(R.id.gas_count);
        gas_price=findViewById(R.id.gas_price);
        select=findViewById(R.id.gas_select);
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout linearLayout=findViewById(R.id.detail3);
                linearLayout.setVisibility(v.VISIBLE);
            }
        });
        spinner=findViewById(R.id.spin_four);
        ...
        public void run() {
            ...
            try {
                ...
                if (responseCode== 200) {
                    ...
                    try {
                        JSONObject gas=new JSONObject(result);
                        //解析并显示
                        code= gas.optInt("code");//接收的值
                        temp1=gas.getString("wateruse");//使用数量
                        temp2=gas.getString("watermoney");//使用金额
                        temp3=gas.getString("watercharge");//单价
                        temp4=gas.getString("waterbank");//余额
        ...
        public void handleMessage(Message msg){
            switch(msg.what){
                case 1://获取到what为1的消息，更新界面显示，不但包括提示信息，还要取消loading状态。
                    if(code==6){
                        gas_bill.setText(temp4);
                        gas_above.setText(temp2);
                        gas_count.setText(temp1);
                        gas_price.setText(temp3);
