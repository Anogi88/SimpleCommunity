...
public class Electric extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText=findViewById(R.id.electric_money);
        ...
        Button pay=findViewById(R.id.electric_pay);//支付按钮
        ...
        public void handleMessage(Message msg){
            switch(msg.what){
                case 1://获取到what为1的消息，更新界面显示，不但包括提示信息，还要取消loading状态。
                    ...
                    //没有支付密码，跳转到设置支付密码页面
                    alert = null;
                    builder = new AlertDialog.Builder(Electric.this);
                    alert = builder.setIcon(R.mipmap.tishi)
                            ...
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    startActivity(new Intent(Electric.this, SetPayPassword.class));
                                    finish();
                                }
        ...
        public void handleMessage(Message msg){
            switch(msg.what){
                case 1://获取到what为1的消息，更新界面显示，不但包括提示信息，还要取消loading状态。
                    if (code== 6) {
                        //跳转到支付成功页面
                        startActivity(new Intent(Electric.this, PaySuccess.class));
                        finish();
                    }if(code==0) {
                    //密码错误
                    alert = null;
