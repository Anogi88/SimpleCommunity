...
public class PayDailog extends Dialog implements View.OnClickListener{
    ...
    public PayDailog(Context context) {
    ...
    void initDilaog() {
        ...
        mEt5 = findViewById(R.id.et_pwd_5);
        mEt6 = findViewById(R.id.et_pwd_6);
    }
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (mEditText.getId() == R.id.et_pwd_real) {
                ...
                for (int i = 0; i < array.length; i++) {
                    //设置图片为黑色圆点
                    if (i == 0) {
                        mEt1.setImageResource(R.drawable.icon_pwd);
                    } else if (i == 1) {
                        mEt2.setImageResource(R.drawable.icon_pwd);
                    } else if (i == 2) {
                        mEt3.setImageResource(R.drawable.icon_pwd);
                    } else if (i == 3) {
                        mEt4.setImageResource(R.drawable.icon_pwd);
                    } else if (i == 4) {
                        mEt5.setImageResource(R.drawable.icon_pwd);
                    } else if (i == 5) {
                        mEt6.setImageResource(R.drawable.icon_pwd);
                    }
                }
